export const POSTS = [
  {
    ...
    slug: "seo/5-must-know-AEO-Strategies-For-2025/",
    date: "October 22, 2025",
    readMins: 8,
    cover: "https://ayatiworks-storage.s3.us-east-1.amazonaws.com/banner/blog-banner.png",
    coverAlt:
  ...
  },
  {
    ...
    slug:
      "seo/How-Your-Tech-Startup-Can-Use-Answer-Engine-Optimization-(AEO)-to-Attract-Engage-and-Convert-Smarter-Audiences/",
  ...
  },
  {
    ...
    slug: "seo/Implementing-AEO-in-Your-Content-Strategy/",
    ...
    deck:
      "Answer Engine Optimization (AEO) isn’t the next big thing, it’s the now thing. As AI Overviews and conversational search take center stage, startups that master ...",
    category: "SEO Services",
  },
  {
    id: 104,
    title: "The Local Agency Advantage for National-Scale ROI ",
    slug: "digital-marketing-services/chennai-digital-marketing-services",

  ...
  return (
    <section className="bg-white py-6 md:pt-20">
      <div className="mx-auto max-w-[1440px] grid gap-3 px-4 md:px-6 grid-cols-2 md:grid-cols-2 xl:grid-cols-12 auto-rows-auto xl:h-[600px] xl:grid-rows-[180px_172px_168px]">
        ...
        >
          <HeroVideo
            src="http://89.167.92.220:8088/banner/banner-01.mov"
        ...
        >
          <Image
            src="http://89.167.92.220:8088/banner/banner-02.webp"
        ...
        >
          <Image
            src="http://89.167.92.220:8088/banner/banner-03.webp"
        ...
        >
          <HeroVideo
            src="http://89.167.92.220:8088/banner/banner-04.mov"
            className="w-full h-full object-cover"
            preload="metadata"
          />
        </motion.div>
        ...
        >
          <Image
            src="http://89.167.92.220:8088/banner/banner-05.webp"
        ...
        >
          <Image
            src="http://89.167.92.220:8088/banner/banner-06.webp"
        ...
        >
          <HeroVideo
            src="http://89.167.92.220:8088/banner/banner-07.mov"
            className="w-full h-full object-cover"
            preload="metadata"
          />
        </motion.div>

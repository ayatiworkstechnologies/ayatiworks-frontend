      ...
      >
        ...
        <motion.div
          ...
          className="
            ...
            aspect-video xl:aspect-auto xl:h-full
          "
        >
          <HeroVideo
        ...
        <motion.div
          ...
          className="
            ...
            rounded-2xl md:rounded-3xl overflow-hidden border border-gray-300
        ...
        <motion.div
          ...
          className="
            ...
            border border-gray-300 rounded-2xl md:rounded-3xl overflow-hidden 
            aspect-[16/9] xl:aspect-auto xl:h-full
          "
        >
          <HeroVideo

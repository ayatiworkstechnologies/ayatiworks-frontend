  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="mx-auto section-container px-4 sm:px-6 pt-6">
        <SplitHeroBanner
          href="#"
          imageSrc="https://ayatiworks-storage.s3.us-east-1.amazonaws.com/banner/blog-103.jpg" // update to your image
          imageAlt="Tech startup implementing AEO framework for smarter audience engagement"
          category="SEO"

...
/* --- Mock meta (swap with your CMS) --- */
const meta = {
  title:
    "Is Your Website Ready for the AI Search Takeover? 5 Must-Know AEO Strategies for 2025",
  description:
    "How AEO works and five strategies to earn citations in AI answers.",
  author: {
    name: "Daniel Joseph",
    slug: "daniel-joseph",
    photo: "https://ayatiworks-storage.s3.us-east-1.amazonaws.com/author/daniel.png",
    role: "Senior SEO Strategist",
  },
  cover: "https://ayatiworks-storage.s3.us-east-1.amazonaws.com/author/daniel.png", // optional
};
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="mx-auto section-container px-4 sm:px-6 pt-6">
        <SplitHeroBanner
          href="#"
          imageSrc="https://ayatiworks-storage.s3.us-east-1.amazonaws.com/banner/blog-banner.png" // update to your image
          imageAlt="AI Search Optimization Strategies for Businesses in 2025 – Visual Guide to AEO Implementation"
          category="SEO"
          title={[
            "Prepare Your Website for the AI Search Revolution",
            "Unlock AEO Secrets for Explosive Organic Growth!",
          ]}
          author={{
            name: "Daniel Joseph",
            slug: "daniel-joseph",

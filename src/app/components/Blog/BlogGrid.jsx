      ...
      <div className="section-container mx-auto p-4 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <Link href={imgs1[0].path} className="absolute inset-0 flex items-center justify-center">
              <div className="opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-75 group-hover:scale-100">
                <div className="w-14 h-14 rounded-full bg-white/20 backdrop-blur-md border border-white/40 flex items-center justify-center shadow-lg hover:scale-110 transition">
                  <ArrowRight className="w-10 h-10 text-white transform -translate-x-1 group-hover:translate-x-0 group-hover:rotate-45 transition-all duration-300" />
                </div>
              </div>
            </Link>

            {imgs1[0].heading && (
              <span className="absolute bottom-2 left-2 font-primary bg-white/90 text-secondary hover:bg-secondary hover:text-white font-medium px-4 py-2 text-xl shadow rounded">
                {imgs1[0].heading}
              </span>
            )}
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {imgs1.slice(1).map((img, index) => (
              ...
              >
                ...
                <Link href={img.path} className="absolute inset-0 flex items-center justify-center">
                  <div className="opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-75 group-hover:scale-100">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <Link href={imgs2[0].path} className="absolute inset-0 flex items-center justify-center">
              <div className="opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-75 group-hover:scale-100">
                <div className="w-14 h-14 rounded-full bg-white/20 backdrop-blur-md border border-white/40 flex items-center justify-center shadow-lg hover:scale-110 transition">
                  <ArrowRight className="w-10 h-10 text-white transform -translate-x-1 group-hover:translate-x-0 group-hover:rotate-45 transition-all duration-300" />
                </div>

  ...
  return (
    <main className="w-full overflow-hidden">
      ...
      <section className="w-full">
        ...
        {/* Mobile Banner */}
        <Image
          src="/banner/spa-banner-mob-1.jpg"
      ...
      <section className="relative w-full bg-[#17A3DC] text-white py-4 md:py-8 px-6 md:px-12 object-cover">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
          ...
          <div className="w-full md:w-2/5 flex justify-center z-10 relative">
            ...
            <Image
              src="/assets/casestudy/spa-1.png"
              alt="The Challenge"
      ...
      <section className="relative w-full min-h-[600px] text-white overflow-hidden flex items-center py-16 md:py-24">
        ...
        <div className="absolute inset-0 w-full h-full">
          <Image
            src="/assets/casestudy/spa-2.png"
            alt="The Strategy"
      ...
      <section className="w-full relative overflow-hidden flex flex-col items-center">
        ...
        <Image
          src="/assets/casestudy/spa-3.png"
          alt="The Execution"
        ...
        <Image
          src="/assets/casestudy/spa-4.jpg"
            ...
            {[
              {
                ...
                image: "/assets/casestudy/spa-vid-1.mp4",
              },
              {
                platform: "Instagram",
                ...
                image: "/assets/casestudy/spa-vid-2.mp4",
              },
              {
                platform: "Instagram",
                ...
                image: "/assets/casestudy/spa-vid-3.mp4",
              },
              {
                platform: "Instagram",
                ...
                image: "/assets/casestudy/spa-vid-4.mp4",
              },
            ].map((post, idx) => (
              <a
                key={idx}
      ...
      <section className="mx-auto w-full bg-zinc-50">
        <div className="relative left-1/2 -translate-x-1/2">
          <div className="relative isolate w-full overflow-hidden">
            <Image
              src="/assets/casestudy/spa-footer.jpg"
            ...
            />
            <Image
              src="/assets/casestudy/spa-footer-mob.jpg"

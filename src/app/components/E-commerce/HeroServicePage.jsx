      ...
      <section className="section-container py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-8">
          ...
          <div className="hidden md:block">
            ...
            <div className="sticky top-20">
              <Image width={800} height={800}
                src="https://ik.imagekit.io/bf5g7wxrp/ayatiworks-storage/assets/service/ecom-1.png"
                alt="Search Engines Work"
                className="w-full h-auto  mx-auto "
              />
            </div>
      ...
      <section className="section-container py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-8">
          ...
          <div className="hidden md:block">
            ...
            <div className="sticky top-20">
              <Image width={800} height={800}
                src="https://ik.imagekit.io/bf5g7wxrp/ayatiworks-storage/assets/service/ecom-2.png"
                alt="Search Engines Work"
                className="w-full h-auto  mx-auto "
              />
            </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-sm sm:text-base font-secondary text-black/70">
                          <span className="text-primary font-primary text-xl font-bold">Result: </span>
                          {result}
                        </p>
                      </div>
                    </div>
